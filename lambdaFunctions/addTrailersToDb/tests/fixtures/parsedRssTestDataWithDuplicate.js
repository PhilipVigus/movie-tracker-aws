const parsedRssTestDataWithDuplicate = [
  {
  ...
  {
    id:
      "http://www.traileraddict.com/awesome-film-2020/feature-trailer",
    title: "Awesome Film: Feature Trailer",
...
module.exports = parsedRssTestDataWithDuplicate;